...
export const logger = {
  ...
  error: (message: string) => {
    ux.stderr(ux.colorize('redBright', message));
  },
  info: (message: string) => {
    ux.stdout(ux.colorize('blueBright', message));
  },
  success: (message: string) => {
    ux.stdout(ux.colorize('greenBright', message));
  },
  ...
  warn: (message: string) => {
    ux.stdout(ux.colorize('yellowBright', message));
  },
};
